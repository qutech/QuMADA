...
import get_from_station as gfs
#%% Other imports
...
def create_or_load_mapping(mapping):
    ...
    class Map_generator:
        """
        Decorator used to separate the gate_mapping class from the stuff that is 
        needed to create/load it. Keep in mind, that it will return the 
        Map_generator object, to access the Gate_mapping() object, 
        usage of .wrap is required (ToDo: Change this)
        """
        def __init__(self, station, **kwargs):
            #Get access to Gate_mapping methods
        ...
        def create_mapping(self):
            """
            Create a new Gate_mapping with user input
            """
            try:
