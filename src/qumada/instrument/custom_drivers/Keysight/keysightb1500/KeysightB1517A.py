...
class KeysightB1517A(B1500Module):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._output_enabled: bool|None = None #None means not set
        ...
        self.add_parameter(
            name="output_enabled",
            set_cmd=self._enable_outputs,
            get_cmd=self._enabled_output,
            snapshot_get=True
        )
        
    def _enable_outputs(self, val: bool):
